...
if __name__ == "__main__":
    ...
    for i in range(num_functions):
        ...
        if do_create:
            ...
            command = "wsk -i action create /whisk.system/%s %s --main %s --web true --concurrency %d --kind %s --memory %d --param actionMemory %d" % (function_name, jar_path, main_class, concurrency, kind, memory, memory)
        else:
            ...
            command = "wsk -i action update /whisk.system/%s %s --main %s --web true --concurrency %d --kind %s --memory %d --param actionMemory %d" % (function_name, jar_path, main_class, concurrency, kind, memory, memory)
